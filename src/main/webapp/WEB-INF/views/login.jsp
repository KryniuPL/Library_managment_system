...
<html lang="pl">
	<head>
		<link rel="shortcut icon" href="../../../../../../Library_managment_system-jsp-test/src/main/webapp/web-resources/favicon.png" />
	...
	<body>
		<div class="container">
			...
			<div class="page-header text-center">
				<h1>Strona logowania do systemu zarządzania biblioteką</h1>
				<img src="../../../../../../Library_managment_system-jsp-test/src/main/webapp/web-resources/favicon.png">
			</div>
			
			<div id="loginform" class="jumbotron jumbotron-form">
				<form>
				  Login<br>
				  ...
				  <br>
				  <input type="submit" class="btn btn-success btn-login" value="Zaloguj">
				</form>
			</div>
		</div>
